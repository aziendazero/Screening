...
public class RefMa_lettura2Action extends RefMa1l_DataForwardAction {
    private RichForm lettura2Form;
    ...
    public void setLettura2Form(RichForm lettura2Form) {
        this.lettura2Form = lettura2Form;
    }

    public RichForm getLettura2Form() {
        if (lettura2Form == null) {
            //filtro i dati
            this.filter();
            //leggo i dati per l aprima lettura
            GestoreRefertiUI.loadFromDB1livMA(2);
        }
        return lettura2Form;
    }
