...
public interface RefCo_AppModule extends Parent_AppModule, ApplicationModule {
    ...
    Integer getNextIdEndoscopiaIntermedia();
    
    Integer getNextIdPolipoIntermedio();
    

    HashMap callImportIntermedi(String ulss, String tpscr, BigDecimal idInterm, String operatore, Integer[] rc);
    ...
    void filterConfiguration(String ulss, String scr, String codregionale, boolean regionale);
