...
public class Ref_SoCnfTpinvitoImpl extends EntityImpl {
    ...
    public enum AttributesEnum {
        Idtpinvito {
            public Object get(Ref_SoCnfTpinvitoImpl obj) {
                return obj.getIdtpinvito();
            }

            public void put(Ref_SoCnfTpinvitoImpl obj, Object value) {
        ...
        Ref_SoInvito1 {
            ...
            public void put(Ref_SoCnfTpinvitoImpl obj, Object value) {
                obj.setRef_SoInvito1((Ref_SoInvitoImpl) value);
            }
        }
        ,
        Ref_SoInvito {
        ...
        public abstract Object get(Ref_SoCnfTpinvitoImpl object);

        public abstract void put(Ref_SoCnfTpinvitoImpl object, Object value);

        public int index() {
            return Ref_SoCnfTpinvitoImpl.AttributesEnum.firstIndex() + ordinal();
        }
        ...
        public static int count() {
            return Ref_SoCnfTpinvitoImpl.AttributesEnum.firstIndex() + Ref_SoCnfTpinvitoImpl.AttributesEnum.staticValues().length;
        }

        public static AttributesEnum[] staticValues() {
            if (vals == null) {
                vals = Ref_SoCnfTpinvitoImpl.AttributesEnum.values();
            }
            return vals;
        }
    }
  ...
  public Ref_SoCnfTpinvitoImpl()
  {
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        return EntityDefImpl.findDefObject("model.referto.Ref_SoCnfTpinvito");
    }
  ...
  protected void setAttrInvokeAccessor(int index, Object value, AttributeDefImpl attrDef) throws Exception
  {
    ...
    /**
     * @return the associated entity Ref_SoInvitoImpl.
     */
    public Ref_SoInvitoImpl getRef_SoInvito1() {
        return (Ref_SoInvitoImpl) getAttributeInternal(REF_SOINVITO1);
    }

    /**
     * Sets <code>value</code> as the associated entity Ref_SoInvitoImpl.
     */
    public void setRef_SoInvito1(Ref_SoInvitoImpl value) {
        setAttributeInternal(REF_SOINVITO1, value);
    }
