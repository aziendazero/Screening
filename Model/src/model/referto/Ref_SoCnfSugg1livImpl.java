...
public class Ref_SoCnfSugg1livImpl extends EntityImpl {
    ...
    public enum AttributesEnum {
        Idsugg {
            public Object get(Ref_SoCnfSugg1livImpl obj) {
                return obj.getIdsugg();
            }

            public void put(Ref_SoCnfSugg1livImpl obj, Object value) {
        ...
        ,
        Ref_SoCnfCriteriSugg1liv {
            public Object get(Ref_SoCnfSugg1livImpl obj) {
                return obj.getRef_SoCnfCriteriSugg1liv();
            }
        ...
        public abstract Object get(Ref_SoCnfSugg1livImpl object);

        public abstract void put(Ref_SoCnfSugg1livImpl object, Object value);

        public int index() {
            return Ref_SoCnfSugg1livImpl.AttributesEnum.firstIndex() + ordinal();
        }
        ...
        public static int count() {
            return Ref_SoCnfSugg1livImpl.AttributesEnum.firstIndex() + Ref_SoCnfSugg1livImpl.AttributesEnum.staticValues().length;
        }

        public static AttributesEnum[] staticValues() {
            if (vals == null) {
                vals = Ref_SoCnfSugg1livImpl.AttributesEnum.values();
            }
            return vals;
        }
    }
    ...
    public static final int REF_SOCNFCRITERISUGG1LIV = AttributesEnum.Ref_SoCnfCriteriSugg1liv.index();

    /**
     *
     *  This is the default constructor (do not remove)
     */
  public Ref_SoCnfSugg1livImpl()
  {
  }
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        return EntityDefImpl.findDefObject("model.referto.Ref_SoCnfSugg1liv");
    }
    ...
    public RowIterator getRef_SoRefertocito1liv()
  {
     ...
     */
    public RowIterator getRef_SoCnfCriteriSugg1liv() {
        return (RowIterator) getAttributeInternal(REF_SOCNFCRITERISUGG1LIV);
    }
