...
import model.conf.Cnf_SoCnfDwhCentriImpl;
...
public class PL_SoCentroPrelRefImpl extends EntityImpl {
    ...
    public enum AttributesEnum {
        Idcentro {
            public Object get(PL_SoCentroPrelRefImpl obj) {
                return obj.getIdcentro();
            }

            public void put(PL_SoCentroPrelRefImpl obj, Object value) {
        ...
        Cnf_SoCnfDwhCentri {
            public Object get(PL_SoCentroPrelRefImpl obj) {
                return obj.getCnf_SoCnfDwhCentri();
            }

            public void put(PL_SoCentroPrelRefImpl obj, Object value) {
                obj.setCnf_SoCnfDwhCentri((Cnf_SoCnfDwhCentriImpl) value);
            }
        }
        ,
        SoRefertocolon1liv {
        ...
        public abstract Object get(PL_SoCentroPrelRefImpl object);

        public abstract void put(PL_SoCentroPrelRefImpl object, Object value);

        public int index() {
            return PL_SoCentroPrelRefImpl.AttributesEnum.firstIndex() + ordinal();
        }
        ...
        public static int count() {
            return PL_SoCentroPrelRefImpl.AttributesEnum.firstIndex() + PL_SoCentroPrelRefImpl.AttributesEnum.staticValues().length;
        }

        public static AttributesEnum[] staticValues() {
            if (vals == null) {
                vals = PL_SoCentroPrelRefImpl.AttributesEnum.values();
            }
            return vals;
        }
    }
    ...
    public static final int CNF_SOCNFDWHCENTRI = AttributesEnum.Cnf_SoCnfDwhCentri.index();
  ...
  public PL_SoCentroPrelRefImpl()
  {
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        return EntityDefImpl.findDefObject("model.pianolavoro.PL_SoCentroPrelRef");
    }
    ...
    public RowIterator getSoRefertocolon1liv()
  {
    ...
    /**
     *
     *  Gets the associated entity Cnf_SoCnfDwhCentriImpl
     */
    public Cnf_SoCnfDwhCentriImpl getCnf_SoCnfDwhCentri()
  {
    return (Cnf_SoCnfDwhCentriImpl)getAttributeInternal(CNF_SOCNFDWHCENTRI);
  }

  /**
   * 
   *  Sets <code>value</code> as the associated entity Cnf_SoCnfDwhCentriImpl
   */
  public void setCnf_SoCnfDwhCentri(Cnf_SoCnfDwhCentriImpl value)
  {
    setAttributeInternal(CNF_SOCNFDWHCENTRI, value);
  }
