...
public class Acc_SoRefertocito1livImpl extends EntityImpl {
    ...
    public enum AttributesEnum {
        Idreferto {
            public Object get(Acc_SoRefertocito1livImpl obj) {
                return obj.getIdreferto();
            }

            public void put(Acc_SoRefertocito1livImpl obj, Object value) {
        ...
        public abstract Object get(Acc_SoRefertocito1livImpl object);

        public abstract void put(Acc_SoRefertocito1livImpl object, Object value);

        public int index() {
            return Acc_SoRefertocito1livImpl.AttributesEnum.firstIndex() + ordinal();
        }
        ...
        public static int count() {
            return Acc_SoRefertocito1livImpl.AttributesEnum.firstIndex() + Acc_SoRefertocito1livImpl.AttributesEnum.staticValues().length;
        }

        public static AttributesEnum[] staticValues() {
            if (vals == null) {
                vals = Acc_SoRefertocito1livImpl.AttributesEnum.values();
            }
            return vals;
        }
    }
     ...
     */
  public Acc_SoRefertocito1livImpl()
  {
  }
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        return EntityDefImpl.findDefObject("model.accettazione.Acc_SoRefertocito1liv");
    }
   ...
   */
  public Integer getNumaccap()
  {
    return (Integer)getAttributeInternal(NUMACCAP);
  }
   ...
   */
  public void setNumaccap(Integer value)
  {
