...
public class Cnf_SoCnfTrialStatoImpl extends EntityImpl {
     ...
     */
	public Cnf_SoCnfTrialStatoImpl() {
	}
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        return EntityDefImpl.findDefObject("model.conf.Cnf_SoCnfTrialStato");
    }
    ...
    /**
     * @param idstatoTrial key constituent
     * @param idtrial key constituent
     * @param tpscr key constituent

     * @return a Key object based on given key constituents.
     */
    public static Key createPrimaryKey(Integer idstatoTrial, Integer idtrial, String tpscr) {
        return new Key(new Object[] { idstatoTrial, idtrial, tpscr });
    }
